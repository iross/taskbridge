...
class TogglAPI:
    ...
    def _make_request(self, method: str, endpoint: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            raise Exception(f"Toggl API timeout: Request took too long to complete")
...
# Global API instance (will be None if token not configured or API unavailable)
try:
    toggl_api = TogglAPI()
except (ValueError, Exception) as e:
    # ValueError: token not configured
    # Exception: API unavailable (rate limited, network error, etc.)
